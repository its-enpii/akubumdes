...
|---|---|---|---|---|---|
| 1 | 1.1 Landing hero + CTA | GET / | h1 "Akubumdes" visible, status 200 | status=200, hero=true | PASS |
...
| 6 | 1.1 Landing hero + CTA | GET / | h1 "Akubumdes" visible, status 200 | status=200, hero=true | PASS |
...
| 11 | 1.1 Landing hero + CTA | GET / | h1 "Akubumdes" visible, status 200 | status=200, hero=true | PASS |
...
| 16 | 1.1 Landing hero + CTA | GET / | h1 "Akubumdes" visible, status 200 | status=200, hero=true | PASS |
...
| 21 | 1.1 Landing hero + CTA | GET / | h1 "Akubumdes" visible, status 200 | status=200, hero=true | PASS |
