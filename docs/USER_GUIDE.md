...
**Akubumdes** adalah aplikasi web modern berbasis komputasi awan (*Multi-Tenant Cloud SaaS*) yang dirancang khusus untuk mengelola operasional **Dana Bergulir Masyarakat (DBM)** pada Badan Usaha Milik Desa Bersama (**BUMDesma**) dan Lembaga Keuangan Desa (**LKD**) di seluruh Indonesia.
...
Siklus perguliran pinjaman di Akubumdes dirancang sesuai prosedur standar operasional (SOP) DBM eks PNPM-MPd / BUMDesma LKD.
...
**Menu:** `Akubumdes -> Register Proposal` (`/lending/loans/create`)
...
**Menu:** `Akubumdes -> Tahapan Perguliran -> Tab Verifikasi`
...
**Menu:** `Akubumdes -> Tahapan Perguliran -> Tab Waiting`
...
**Menu:** `Akubumdes -> Detail Pinjaman -> Tombol Cairkan Dana`
...
Mengelola langganan lisensi operasional Akubumdes untuk lembaga BUMDesma Anda.
...
Disediakan khusus untuk instansi BUMDesma baru yang ingin bermigrasi dari sistem manual/Excel ke Akubumdes:
...
- **Alat Cutover Migrasi Database Legacy**: Migrasi instan database Akubumdes versi lama (PHP murni/MySQL) ke Akubumdes.
