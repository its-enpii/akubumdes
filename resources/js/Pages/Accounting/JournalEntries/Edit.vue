  ...
  (type, prev) => {
    ...
    if (type !== prev) {
      if (!isInventory.value) {
        ...
        if (life !== undefined && !form.asset_useful_life_months)
          form.asset_useful_life_months = life;
    ...
    <div class="mx-auto max-w-4xl space-y-6">
      <header>
        ...
        <h1 class="mt-1 text-2xl font-bold text-primary sm:text-3xl">
          Koreksi Jurnal #{{ originalEntry.id }}
        </h1>
        <p class="mt-1 text-sm text-on-surface-variant">
          Jurnal lama akan di-<strong>reverse</strong> dan diganti dengan jurnal
          baru menggunakan data di bawah ini. Audit trail tetap utuh.
        </p>
      </header>
      ...
      <AppCard>
        <div class="flex flex-wrap items-start gap-3">
          <div
            class="grid size-12 shrink-0 place-items-center rounded-full bg-warning-container text-warning"
          >
          ...
          <div class="flex-1">
            ...
            <ul class="mt-2 space-y-1 text-sm text-on-surface-variant">
              ...
              <li
                v-if="originalEntry.description"
            ...
            <p class="mt-2 text-sm text-warning">
              Jurnal lama tidak berubah sampai Anda klik
              <strong>Simpan Koreksi</strong>. Kedua jurnal (reversal + baru)
              akan dibuat bersamaan dalam satu transaksi.
            </p>
          </div>
        </div>
      </AppCard>
      ...
      <AppCard
        v-if="page.props.errors?.reason"
        class="border border-error/40 bg-error-container/40"
      >
      ...
      <AppCard>
        <template #header>
          <div class="flex items-center justify-between gap-3">
            <div>
              ...
              <p class="mt-1 text-sm text-on-surface-variant">
                Lengkapi data jurnal baru di bawah ini.
              </p>
            </div>
        ...
        <form class="space-y-5" @submit.prevent="submit">
          ...
          >
            <AppButton variant="secondary" type="button" @click="cancel"
              >Batal</AppButton
            >
            <AppButton
              type="submit"
