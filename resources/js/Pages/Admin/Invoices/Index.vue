      ...
      >
        <div>
          ...
          <p class="mt-1 text-on-surface-variant">
            Tagihan tenant: langganan, setup, support, training, custom, dll.
          </p>
        </div>
        <Link href="/admin/invoices/create"
          ><AppButton icon="add">Buat Invoice</AppButton></Link
        >
      </header>
          ...
          >
            ...
            <template #cell-purpose="{ row }">
              ...
              <span
                ...
                class="block truncate text-xs text-on-surface-variant"
            ...
            <template #cell-status="{ row }">
              <div class="flex items-center gap-1.5 flex-wrap">
                ...
                <span
                  v-if="row.blocks_access"
                  class="rounded bg-error/15 px-1.5 py-0.5 text-[10px] font-bold text-error"
                  title="Tagihan memblokir akses jika belum lunas"
                >
                  Blokir
                </span>
              </div>
            ...
            <template #actions="{ row }">
              <Link :href="`/admin/invoices/${row.row_id}`"
