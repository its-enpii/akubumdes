...
<svg width="240" height="200" viewBox="0 0 240 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g filter="url(#drop-shadow-419)">
        ...
        <path d="M96 60H144M96 140H144" stroke="#115E59" stroke-width="3.5" stroke-linecap="round" />
        <path d="M102 60C102 85 116 95 120 100C124 95 138 85 138 60H102Z" fill="#115E59" fill-opacity="0.08" stroke="#115E59" stroke-width="2" />
        <path d="M102 140C102 115 116 105 120 100C124 105 138 115 138 140H102Z" fill="#059669" fill-opacity="0.2" stroke="#115E59" stroke-width="2" />
        <circle cx="120" cy="102" r="1.5" fill="#059669" />
        <circle cx="120" cy="110" r="1.5" fill="#059669" />
        <circle cx="120" cy="118" r="1.5" fill="#059669" />
        <path d="M108 136C108 130 114 125 120 125C126 125 132 130 132 136H108Z" fill="#059669" />
    </g>
