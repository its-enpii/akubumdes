...
<svg width="240" height="200" viewBox="0 0 240 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g filter="url(#drop-shadow-401)">
        ...
        <rect x="85" y="112" width="70" height="6" rx="3" fill="#115E59" fill-opacity="0.25" />
        <rect x="95" y="124" width="50" height="5" rx="2.5" fill="#64748B" fill-opacity="0.2" />
        <rect x="90" y="142" width="60" height="14" rx="4" fill="#059669" fill-opacity="0.12" />
        <text x="120" y="152" fill="#059669" font-size="8" font-weight="bold" font-family="Inter, sans-serif" text-anchor="middle">LOGIN REQUIRED</text>
    </g>
    <g transform="translate(142, 105)">
        <circle cx="18" cy="18" r="14" fill="#115E59" stroke="#FFFFFF" stroke-width="2.5" />
        <circle cx="18" cy="18" r="6" fill="#FFFFFF" />
        <path d="M28 28L48 48M42 42L47 37M46 46L51 41" stroke="#115E59" stroke-width="4" stroke-linecap="round" />
    </g>
    <defs>
