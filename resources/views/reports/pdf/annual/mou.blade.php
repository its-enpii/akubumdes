...
@section('content')
    <table border="0" width="100%" style="font-size: 11px; text-align: center; margin-bottom: 15px;">
        <tr>
            <td>
                ...
                <div style="font-size: 12px; font-weight: bold; color: #2b6cb0;">TENTANG PENGELOLAAN USAHA BERSAMA & TATA KELOLA KEUANGAN {{ strtoupper($identity['legal_name']) }}</div>
            </td>
        </tr>
    </table>
    ...
    <div style="font-size: 10.5px; line-height: 1.6; text-align: justify;">
        <p>
            Pada hari ini, <b>{{ $date_formatted }}</b>, kami yang bertandatangan di bawah ini para Kepala Desa di wilayah Kecamatan {{ $identity['district_name'] }} Kabupaten {{ $identity['regency_name'] }}, bertindak untuk dan atas nama Pemerintah Desa masing-masing, menyatakan bersepakat untuk mengikatkan diri dalam Perjanjian Kerjasama Pengelolaan Usaha Bersama dan Tata Kelola Keuangan BUMDes melalui {{ $identity['legal_name'] }} dengan ketentuan:
        </p>
        <ol style="margin-left: 20px;">
            ...
            <li><b>Pasal 2: Kepemilikan Bersama</b> — Seluruh aset, modal, dan surplus usaha BUMDes adalah milik bersama desa-desa pendiri yang dikelola secara profesional, transparan, dan akuntabel sesuai standar akuntansi yang berlaku.</li>
